...
export interface ApiFaqItemFaqItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Preguntas frecuentes, una por entrada, para la p\u00E1gina /contacto/faq';
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'P\u00E1ginas est\u00E1ticas editables (Home, Qui\u00E9nes somos, FAQ, etc.)';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProcessStepProcessStep extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pasos del proceso artesanal, para la secci\u00F3n Procesos';
...
export interface ApiProductCategoryProductCategory
  ...
  info: {
    description: 'Categor\u00EDas del cat\u00E1logo (ej: Mates, Regalos, Accesorios)';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Items de la carta / cat\u00E1logo de productos';
    displayName: 'Product';
    pluralName: 'products';
  ...
  attributes: {
    ...
    is_on_stock: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuraci\u00F3n global del sitio: logo, contacto, hero';
